      ...
      <main className="flex-1">
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="flex items-center justify-center mb-8 relative">
                <div className="absolute left-0 h-1 w-16 bg-gradient-to-r from-teal-500 to-teal-300 rounded-full"></div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mx-4 text-center relative inline-block">
                  The Team
                  <motion.span 
                    className="absolute -top-1 -right-6 text-teal-500"
                    animate={{ rotate: [0, 20, 0] }}
                    transition={{ duration: 2, repeat: Infinity }}
                  >
                ...
                <div className="absolute right-0 h-1 w-16 bg-gradient-to-r from-teal-300 to-teal-500 rounded-full"></div>
              </div>
              
              <motion.div 
                className="bg-white rounded-2xl shadow-xl p-8 border border-teal-100 relative overflow-hidden"
                whileHover={{ 
                  boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
                }}
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
              >
                <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-b from-teal-100 to-blue-100 rounded-full transform translate-x-20 -translate-y-20 opacity-30"></div>
                
                <p className="text-gray-700 mb-4 text-lg relative z-10">
                  Aidify was developed by a multidisciplinary team of AI researchers, software engineers, and healthcare professionals passionate about improving emergency response through technology.
                </p>
                <p className="text-gray-700 mb-4 text-lg relative z-10">
                  Our advisors include emergency medicine specialists, first responders, and public health experts who help ensure the accuracy and effectiveness of our platform.
                </p>
                <p className="text-gray-700 mb-8 text-lg relative z-10">
                  We're constantly working to improve Aidify's capabilities and expand its reach to help more people during medical emergencies.
                </p>
                ...
                <div className="flex flex-col md:flex-row justify-center gap-6">
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button 
                      asChild
                      variant="outline"
                      className="border-teal-500 text-teal-500 hover:bg-teal-50 relative overflow-hidden group"
                    >
                      <Link to="/contact">
                        <span className="absolute inset-0 w-full h-full bg-teal-500 opacity-0 group-hover:opacity-10 transition-opacity duration-300"></span>
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button 
                      asChild
                      className="bg-gradient-to-r from-teal-500 to-blue-500 hover:from-teal-600 hover:to-blue-600 relative overflow-hidden group"
                    >
                      <Link to="/app">
