...
const firstAidInstructionsTemplates: Record<InjuryTypeCategory, FirstAidInstructionsProps> = {
  ...
  "cardiac": {
    ...
    location: "Chest",
    steps: [
      { id: 1, content: "Call emergency services (911) immediately.", important: true, hasAudio: true },
  ...
  "stroke": {
    ...
    severity: "high",
    steps: [
      { id: 1, content: "Call emergency services (911) immediately - note the time symptoms first appeared.", important: true, hasAudio: true },
  ...
  "choking": {
    ...
    steps: [
      ...
      { id: 6, content: "If the person becomes unconscious, carefully lower them to the ground, call 911, and begin CPR if trained.", hasVideo: true }
    ],
  ...
  "allergic": {
    ...
    steps: [
      ...
      { id: 2, content: "For severe reactions (difficulty breathing, swelling of face/throat, dizziness): Use an epinephrine auto-injector (EpiPen) if available and call 911 immediately.", important: true, hasVideo: true, hasAudio: true },
  ...
  "head": {
    ...
    bloodLevel: "minimal",
    steps: [
      { id: 1, content: "Call emergency services (911) for moderate to severe head injuries.", important: true, hasAudio: true },
  ...
  "poisoning": {
    ...
    severity: "high",
    steps: [
      { id: 1, content: "Call the Poison Control Center (1-800-222-1222) or emergency services (911) immediately.", important: true, hasAudio: true },
